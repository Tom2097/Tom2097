...
import { BarChart3, Globe, Mail, MessageSquare, Search, ExternalLink, TrendingUp, DollarSign } from "lucide-react"
...
const sources: LeadSource[] = [
  { source: "LinkedIn Ads", leads: 245, conversion: 8.2, revenue: 184000, cost: 32000, roi: 475, trend: "up" },
  { source: "Google Search", leads: 312, conversion: 6.5, revenue: 226000, cost: 45000, roi: 402, trend: "stable" },
  { source: "Email Outreach", leads: 180, conversion: 12.4, revenue: 198000, cost: 12000, roi: 1550, trend: "up" },
  { source: "Content Marketing", leads: 95, conversion: 9.1, revenue: 95000, cost: 18000, roi: 428, trend: "stable" },
  { source: "Referrals", leads: 62, conversion: 21.0, revenue: 142000, cost: 5000, roi: 2740, trend: "up" },
  { source: "Trade Shows", leads: 128, conversion: 4.8, revenue: 78000, cost: 35000, roi: 123, trend: "down" },
]
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <Badge variant="outline" className="text-[10px]">Total ROI: {((totalRevenue - totalCost) / totalCost * 100).toFixed(0)}%</Badge>
        </div>
      </div>
